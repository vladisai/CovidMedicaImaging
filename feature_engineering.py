...
def load_data(input_path,target_size=None,crop_by_pixels=None,crop_by_factors=None,**kwargs):
  ...
  try:
    ...
    logging.info('Images coverted to greyscale')
  except:
...
def main(input_path,output_path,lbp,hog,lbp_kwargs={},hog_kwargs={},preprocessing_kwargs={}):
...
if __name__=='__main__':
  ...
  main(args.input_path,args.output_path,args.lbp,args.hog,eval(args.lbp_kwargs),eval(args.hog_kwargs),eval(args.preprocessing_kwargs))
